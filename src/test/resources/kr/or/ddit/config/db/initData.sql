...
Insert into USERS (USERID,USERNM,PASS,REG_DT,ALIAS,ADDR1,ADDR2,ZIPCODE,FILENAME,REALFILENAME) values ('brown','브라운','brownPass',to_date('2020/11/05','YYYY/MM/DD'),'곰','z','z','z',null,null);
...
Insert into USERS (USERID,USERNM,PASS,REG_DT,ALIAS,ADDR1,ADDR2,ZIPCODE,FILENAME,REALFILENAME) values ('bani','반이슬','1234',to_date('2020/11/11','YYYY/MM/DD'),'bani','대전 중구 중앙로 76','영민빌딩 4층 404호','34904',null,null);
